...
# Hardcode API keys for standalone executable portability
try:
    groq_client = groq.Groq(api_key="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")
except Exception:
    groq_client = None
...
# Initialize Firebase
try:
    cred_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "..", "flow-dictation-firebase-adminsdk-fbsvc-99d52a4fbf.json")
    if hasattr(sys, '_MEIPASS'):
        cred_path = os.path.join(sys._MEIPASS, "flow-dictation-firebase-adminsdk-fbsvc-99d52a4fbf.json")
    ...
    def process_audio(self, filename):
        try:
            ...
            try:
                ...
                try: print(f"Metrics error: {e}")
                except: pass
            
            print("Formatted: " + final_text)
